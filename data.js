...
const allEpisodes = {
    ...
    1: [
		{
		  title: "<br>BİR ANDA YERLE BİR<br><span class='episode-number'>[001]</span> 1. Sezon 1. Bölüm",
    ...
    1: [
		{
		  title: "<br>DEHŞET ANLARI<br><span class='episode-number'>[001]</span> 1. Sezon 1. Bölüm",
		  ...
		  description: "Eric, Greensburg'u yerle bir eden bir kasırganın peşinde koşarken kendini bir fırtınanın göbeğinde bulur, paraşütleri bozulan bir paraşütçü 14.000 fit yükseklikten düşer ve Dave ısırılır...",
		  tags: ["Kasırga", "Paraşüt", "Yılan Isırması", "Vinçte Mahsur Kalma", "Yangın"]
		}
    ],
    seasonYears: {
		1: 2010
    ...
    "Felaket Anları": {
		 ...
		 },
	   {
		...
		description: "Avusturya'nın Galtür dağ köyünde, köyü çevreleyen dağlardaki kar birikir. Ay boyunca değişen sıcaklık nedeniyle, karın altında güçlü ama kırılgan bir buz tabakası oluşur. Felaket günü, buz tabakası çöker ve oluşan buz bankası yamaçtan aşağı kayarak bir toz çığı oluşturur. İki dakika sonra, Galtür'e çarpar ve 57 kişiyi kara gömer, 31'ini öldürür.",
		tags: ["Çığ", "Kar Tsunamisi", "1999", "Köpekler", "Avusturya"]
		},		
		{
		...
		description: "İki aylık bir Boeing 737-400 olan British Midland Flight 92, Londra'daki Heathrow Havaalanı'ndan Belfast'a doğru havalanıyor. Yoldayken uçağın sol motorunda bir fan pervanesi arızası meydana geliyor. Mürettebat yanlış motoru kapatıyor ve East Midlands Havaalanı'na acil iniş için hazırlıklara başlıyor. Havaalanına yaklaşırken hasarlı sol motor tamamen arızalanıyor ve ardından alev alıyor. İrtifasını korumak için yeterli itme gücü olmayan uçak, Kegworth'teki M1 otoyolu setinde pistten 900 metre uzakta yere çakılıyor ve 47 kişi ölüyor, ancak mucizevi bir şekilde uçak otoyoldan çıkmayı başarıyor ve yerde daha fazla can kaybı olmasını engelliyor.",
		tags: ["Uçak", "Çalışan motorun Kapatılması", "1989", "	Acil İniş", "İngiltere"]
		},
	  ],
    seasonYears: {
	  1: 2004,
    ...
    1: [
	    ...
	    fragman: "<a href='https://www.youtube.com/watch?v=3P5N0kd6pYY' target='_blank' title='FRAGMAN : Alive (1993) Trailer' onclick='window.open(this.href, \"_blank\", \"fullscreen=yes, scrollbars=yes\"); return false;'><img src='./img/fragman.jpg' alt='fragman Icon' style='width: 120px; height: 60px; margin-right: 8px; vertical-align: middle; float: left;' /></a>",
